...
import { DAI_MAINNET, UNI, USDC_MAINNET, USDT_MAINNET, WBTC, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
...
export const STAKING_REWARDS_INFO: {
  ...
  1: [
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.MAINNET] as Token, DAI_MAINNET],
    ...
    {
      tokens: [WRAPPED_NATIVE_CURRENCY[SupportedChainId.MAINNET] as Token, USDT_MAINNET],
