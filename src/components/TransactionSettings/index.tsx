...
export default function TransactionSettings({ placeholderSlippage }: TransactionSettingsProps) {
  ...
  const tooHigh = userSlippageTolerance !== 'auto' && userSlippageTolerance.greaterThan(new Percent(0, 100))
        ...
        {slippageError || tooLow || tooHigh ? (
          ...
          >
            {slippageError ? (
              ...
              <Trans>Your transaction may be frontrun when not using the MevSwap Router</Trans>
            )}
          </RowBetween>
        ) : null}
      </AutoColumn>
