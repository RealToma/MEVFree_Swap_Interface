...
export default function Menu() {
  ...
  const showUNIClaimOption = Boolean(false)
  const showLegalOption = Boolean(false)
  const showHelpOption = Boolean(false)
  const showDocsOption = Boolean(false)
  const showRequestOption = Boolean(false)
          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://cdn.mevfree.dev/mevfree-whitepaper.pdf">
                      <div>
                    ...
                    <MenuItem href="https://t.me/MevFree">
                      <div>
                        <Trans>Telegram</Trans>
                      </div>
                      <MessageCircle opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://twitter.com/mevfree">
                      <div>
                        <Trans>Twitter</Trans>
                      </div>
                      <Twitter opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://discord.gg/aGvXZk8zdS">
                      <div>
                        <Trans>Discord</Trans>
                      </div>
                      <MessageCircle opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://github.com/mevfree">
                      <div>
                        <Trans>GitHub</Trans>
                      </div>
