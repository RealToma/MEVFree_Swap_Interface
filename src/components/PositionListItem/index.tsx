...
import { Percent, Price, Token } from 'mevswap/sdk-core'
import { Position } from 'mevswap/v3-sdk'
...
import { DAI_MAINNET, USDC_MAINNET, USDT_MAINNET, WBTC, WRAPPED_NATIVE_CURRENCY } from '../../constants/tokens'
...
export function getPriceOrderingFromPositionForUI(position?: Position): {
  ...
  const stables = [DAI_MAINNET, USDC_MAINNET, USDT_MAINNET]
