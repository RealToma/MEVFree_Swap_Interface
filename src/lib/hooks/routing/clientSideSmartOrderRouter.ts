...
import { BigintIsh, CurrencyAmount, Token, TradeType } from 'mevswap/sdk-core'
import { AlphaRouter, AlphaRouterConfig, AlphaRouterParams } from 'mevswap/smart-order-router/routers/alpha-router'
import { ChainId } from 'mevswap/smart-order-router/util/chains'
...
async function getQuote(
  ...
  console.log('AlphaRouter router: ', router)
  ...
  //console.log('AlphaRouterswapRoute: ', swapRoute)
