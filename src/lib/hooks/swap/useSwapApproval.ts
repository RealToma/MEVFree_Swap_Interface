...
import { Protocol, Trade } from 'mevswap/router-sdk'
import { Currency, CurrencyAmount, Percent, Token, TradeType } from 'mevswap/sdk-core'
import { PAIR, Pair, Route as V2Route, Trade as V2Trade } from 'mevswap/v2-sdk'
import { Pool, Route as V3Route, Trade as V3Trade } from 'mevswap/v3-sdk'
...
function useSwapApprovalStates(
  ...
  const v2RouterAddress = chainId ? PAIR.ROUTER : undefined
  const v3RouterAddress = chainId ? PAIR.ROUTER_V3 : undefined
  const swapRouterAddress = chainId ? PAIR.SWAP_ROUTER : undefined
