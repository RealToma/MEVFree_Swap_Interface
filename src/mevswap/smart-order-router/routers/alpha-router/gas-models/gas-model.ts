...
import {
  DAI_PULSECHAIN,
  DAI_PULSECHAIN_TESTNET,
  USD_BSC,
  USDC_PULSECHAIN,
  USDC_PULSECHAIN_TESTNET,
  USDT_PULSECHAIN,
  USDT_PULSECHAIN_TESTNET,
...
export const usdGasTokensByChain: { [chainId in ChainId]?: Token[] } = {
  ...
  [ChainId.OPTIMISTIC_KOVAN]: [DAI_OPTIMISTIC_KOVAN, USDC_OPTIMISTIC_KOVAN, USDT_OPTIMISTIC_KOVAN],
  ...
  [ChainId.BSC]: [USD_BSC, USDC_BSC, USDT_BSC, DAI_BSC],
  [ChainId.PULSECHAIN]: [USDC_PULSECHAIN, USDT_PULSECHAIN, DAI_PULSECHAIN],
  [ChainId.PULSECHAIN_TESTNET]: [USDC_PULSECHAIN_TESTNET, USDT_PULSECHAIN_TESTNET, DAI_PULSECHAIN_TESTNET],
