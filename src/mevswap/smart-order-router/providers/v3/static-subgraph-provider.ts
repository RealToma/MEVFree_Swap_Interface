import { DAI_BASE, USDC_BASE } from 'constants/tokens'
...
const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC]: [WRAPPED_NATIVE_CURRENCY[ChainId.BSC], USDC_BSC, USDT_BSC],
  [ChainId.EVMOS]: [WRAPPED_NATIVE_CURRENCY[ChainId.EVMOS], USDC_EVMOS, USDT_EVMOS],
  [ChainId.DOGECHAIN]: [WRAPPED_NATIVE_CURRENCY[ChainId.DOGECHAIN]],
  [ChainId.DOGECHAIN_TESTNET]: [WRAPPED_NATIVE_CURRENCY[ChainId.DOGECHAIN_TESTNET]],
  ...
  [ChainId.MOONBEAM]: [WRAPPED_NATIVE_CURRENCY[ChainId.MOONBEAM], DAI_MOONBEAM, USDC_MOONBEAM, WBTC_MOONBEAM],
  [ChainId.PULSECHAIN]: [WRAPPED_NATIVE_CURRENCY[ChainId.PULSECHAIN]],
  [ChainId.PULSECHAIN_TESTNET]: [WRAPPED_NATIVE_CURRENCY[ChainId.PULSECHAIN_TESTNET]],
  [ChainId.BASE]: [WRAPPED_NATIVE_CURRENCY[ChainId.BASE], DAI_BASE, USDC_BASE],
}
