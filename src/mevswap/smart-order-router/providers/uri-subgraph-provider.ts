 ...
 */
export class URISubgraphProvider<TSubgraphPool extends V2SubgraphPool | V3SubgraphPool> {
  constructor(private chainId: ChainId, private uri: string, private timeout = 6000, private retries = 2) {}
