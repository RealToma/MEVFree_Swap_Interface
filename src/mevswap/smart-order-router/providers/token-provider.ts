import { DAI_BASE } from 'constants/tokens'
...
export const USDC_BSC = new Token(ChainId.BSC, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 6, 'USDC', 'USD//C')
export const USDC_EVMOS = new Token(ChainId.EVMOS, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 6, 'USDC', 'USD//C')

export const USDT_BSC = new Token(ChainId.BSC, '0x55d398326f99059fF775485246999027B3197955', 6, 'USDT', 'Tether USD')

export const DAI_BSC = new Token(ChainId.BSC, '0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3', 18, 'DAI', 'Dai Stablecoin')
...
export const USDT_EVMOS = new Token(
  ChainId.EVMOS,
  '0x5885629C32bA29A29F0C6FEaF2717363473916ed',
  6,
  'USDT',
  'Tether USD'
)
