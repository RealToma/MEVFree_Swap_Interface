import { Currency, CurrencyAmount, Fraction, Percent, Price, TradeType } from 'mevswap/sdk-core'
import { Pair, Route as V2RouteSDK, Trade as V2TradeSDK } from 'mevswap/v2-sdk'
import { Pool, Route as V3RouteSDK, Trade as V3TradeSDK } from 'mevswap/v3-sdk'
...
export class Trade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
  ...
  public minimumAmountOut(slippageTolerance: Percent, amountOut = this.outputAmount): CurrencyAmount<TOutput> {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      //console.log('minimumAmountOut - slippageTolerance :', slippageTolerance)
      //console.log('minimumAmountOut - slippageAdjustedAmountOut :', slippageAdjustedAmountOut)
  ...
  public maximumAmountIn(slippageTolerance: Percent, amountIn = this.inputAmount): CurrencyAmount<TInput> {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      //console.log('maximumAmountIn - slippageTolerance :', slippageTolerance)
      //console.log('maximumAmountIn - slippageAdjustedAmountIn :', slippageAdjustedAmountIn)
