import { Currency, CurrencyAmount, Percent, Token, TradeType, validateAndParseAddress } from 'mevswap/sdk-core'
import invariant from 'tiny-invariant'

import { PAIR, SupportedRouterId } from './constants'
...
export abstract class Router {
  ...
  public static swapCallParameters(
    ...
    let value: string
    switch (PAIR.ROUTERID) {
      case SupportedRouterId.DOGECHAINDOGESWAP:
      case SupportedRouterId.DOGECHAINTESTNETDOGESWAP:
      case SupportedRouterId.DOGECHAINMEVSWAP:
        ...
        break
      case SupportedRouterId.DOGECHAINDOGESHREK:
        switch (trade.tradeType) {
          case TradeType.EXACT_INPUT:
            if (etherIn) {
              methodName = useFeeOnTransfer
        ...
        break
      case SupportedRouterId.BSCSWAP:
        switch (trade.tradeType) {
          case TradeType.EXACT_INPUT:
            if (etherIn) {
              methodName = useFeeOnTransfer
