...
export const CUSTOM_BASES: { [chainId: number]: { [tokenAddress: string]: Token[] } } = {
  [SupportedChainId.MAINNET]: {
    [AMPL.address]: [DAI_MAINNET, WRAPPED_NATIVE_CURRENCY[SupportedChainId.MAINNET] as Token],
  },
}
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.BSC]: [
    ...
    CAKE_BSC,
    MIM_BSC,
    WRAPPED_NATIVE_CURRENCY[SupportedChainId.BSC] as Token,
  ],
  [SupportedChainId.EVMOS]: [
    ...
    madDAI,
    madWBTC,
    WRAPPED_NATIVE_CURRENCY[SupportedChainId.EVMOS] as Token,
  ],
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
  [SupportedChainId.MAINNET]: [
    ...
    [USDC_MAINNET, USDT_MAINNET],
    [DAI_MAINNET, USDT_MAINNET],
  ],
}
