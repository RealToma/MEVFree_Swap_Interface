...
import { CurrencyAmount, Fraction, Percent, Price, Token } from 'mevswap/sdk-core'
import { PAIR } from 'mevswap/v2-sdk'
import { FeeAmount, Pool, Position, priceToClosestTick, TickMath } from 'mevswap/v3-sdk'
...
function V2PairMigration({
  ...
  const v2FactoryAddress = chainId ? PAIR.ROUTER : undefined
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <SettingsTab placeholderSlippage={DEFAULT_MIGRATE_SLIPPAGE_TOLERANCE} legacyMode={legacyMode} />
        </AutoRow>
