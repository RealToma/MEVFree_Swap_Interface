...
import { Currency, CurrencyAmount, Price, Token, TradeType } from 'mevswap/sdk-core'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.ROPSTEN]: CurrencyAmount.fromRawAmount(USDC_ROPSTEN, 100_000e6),
  [SupportedChainId.RINKEBY]: CurrencyAmount.fromRawAmount(USDC_RINKEBY, 100_000e6),
  [SupportedChainId.ARBITRUM_ONE]: CurrencyAmount.fromRawAmount(USDC_ARBITRUM, 10_000e6),
  [SupportedChainId.OPTIMISM]: CurrencyAmount.fromRawAmount(DAI_OPTIMISM, 10_000e18),
  [SupportedChainId.POLYGON]: CurrencyAmount.fromRawAmount(USDC_POLYGON, 10_000e6),
  [SupportedChainId.CELO]: CurrencyAmount.fromRawAmount(CUSD_CELO, 10_000e18),
  [SupportedChainId.BSC]: CurrencyAmount.fromRawAmount(USDC_BSC, 100_000e18),
  [SupportedChainId.EVMOS]: CurrencyAmount.fromRawAmount(USDC_EVMOS, 100_000e6),
}
