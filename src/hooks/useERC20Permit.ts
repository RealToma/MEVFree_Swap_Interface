...
import { Trade as V2Trade } from 'mevswap/v2-sdk'
import { Trade as V3Trade } from 'mevswap/v3-sdk'
import { useMemo, useState } from 'react'

import { SWAP_ROUTER_ADDRESSES, V3_ROUTER_ADDRESS } from '../constants/addresses'
import { DAI_MAINNET, UNI, USDC_MAINNET } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  1: {
    ...
    [DAI_MAINNET.address]: { type: PermitType.ALLOWED, name: 'Dai Stablecoin', version: '1' },
