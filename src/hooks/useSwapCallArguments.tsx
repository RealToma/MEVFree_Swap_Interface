...
import { SwapRouter, Trade } from 'mevswap/router-sdk'
import { Currency, Percent, TradeType } from 'mevswap/sdk-core'
import { Router as V2SwapRouter, Trade as V2Trade } from 'mevswap/v2-sdk'
import { FeeOptions, SwapRouter as V3SwapRouter, Trade as V3Trade } from 'mevswap/v3-sdk'
...
export function useSwapCallArguments(
  ...
  //console.log('useSwapCallArguments trade: ', trade)
